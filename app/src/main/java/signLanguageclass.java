...
public class  signLanguageclass {
    ...
    signLanguageclass(Button clear_button, Button add_button, TextView change_text,AssetManager assetManager, String modelPath, String labelPath, int inputSize, String classification_model, int classification_inputsize) throws IOException{
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                Bitmap scaledBitmap2=Bitmap.createScaledBitmap(bitmap1,Classification_inputsize,Classification_inputsize,false);
                ByteBuffer byteBuffer1=convertBitmapToByteBuffer2(scaledBitmap2);
